...
import logging
from 期末作业.bangumi import BangumiDownloader
from 期末作业.video import VideoDownloader
import re
...
def index():
    if request.method == 'POST':
        ...
        user_cookie_value = 'custom_cookie' in request.form
        user_cookie = {
        ...
        detailed_log_input = request.form.get('detailed_log_value', 'n')
